  ...
  return (
    <section className={styles.over_mij}>
      ...
      <p>
        ...
        vastbesloten om mijn vaardigheden en kennis voortdurend uit te breiden.
      </p>
      <p>
        Ik ben vastbesloten om mijn creatieve potentieel volledig te benutten en
        een blijvende indruk achter te laten met mijn werk. Ik geniet ervan om
        mensen te inspireren met mijn unieke visie en talenten. Ik geloof dat
        mijn inzet, samen met mijn passie voor fotografie en vormgeving, me zal
        helpen om opmerkelijke visuele creaties te produceren die mensen
        inspireren.
      </p>
      <p>
